...
The layered mud in the image above depicts a Bouma sequence, which to the untrained eye,
is... whatever man, it's mud. To the trained eye however, it is a dead giveaway that the
...
easy to go from prior to posterior, which will be an important part of this process.
...
For example, observing a perfect [Bouma
sequence](https://en.wikipedia.org/wiki/Bouma_sequence)---like that shown in the first
...
So you see... it's just a simple matter of setting all those alpha scores, all the
connections between observations, and all the edge weights of those connections! Why
