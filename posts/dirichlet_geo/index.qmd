...
environments, in this context. The Dirichlet distribution can generates samples from a
"unit simplex" (a vector of numbers that add to 1), which makes it well suited for
modelling our uncertainty over interpretations, where we allocate some probability to
each.
