...
$$
\begin{align}
A \not\rightarrow F \quad &and \quad A \not\leftarrow F \\
...
because of that latent intuition we have about how human hierarchies work, whereas the
...
but the lightswitch doesn't move. You conclude that the precense of light is not causing
